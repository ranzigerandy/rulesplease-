...
export default function GameStatusScreen() {
  ...
  return <Screen>
    ...
    {review ? <View style={styles.review}><View style={styles.stateIcon}><BookOpenCheck color={colors.text} size={32} /></View><Text style={styles.title}>Is this the right rulebook?</Text>
      ...
      <View style={styles.sourceCard}><Text style={styles.sourceTitle}>{row.game.name}</Text><Text style={styles.sourceMeta}>{row.rulebookSource?.language?.toUpperCase()}</Text><Text style={styles.sourceLabel}>{row.rulebookSource?.label}</Text></View>
